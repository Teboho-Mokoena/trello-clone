                ...
                <div>
                  ...
                  {image && (
                    <Image
                      ...
                      className="w-full h-44 object-cover mt-2 filter hover: grayscale
                            transition-all duration-150 curor-not-allowed"
                  ...
                  <div className="mt-4">
                    ...
                    disabled={!newTaskInput}
                        className="inline-flex justify-center rounded-md border-transparent bg-blue-100 px-4 py-2
